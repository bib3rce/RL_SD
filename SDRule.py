...
class SDRule :
    ...
    def calculateRefinementQuality(self):
        ...
        if self.refinement_heuristics == "":
            ...
            self.refinement_quality = 1.0*(len(self.TP) + m*self.NTC/(self.N_examples))/(len(self.TP) + len(self.FP) + m)
    ...
    def calculateSelectionQuality(self):
        ...
        if self.selection_heuristics == "":
            ...
            self.selection_quality = 1.0*(len(self.TP) + m*self.NTC/(self.N_examples))/(len(self.TP) + len(self.FP) + m)
