...
class DoubleBeam:
    def __init__(self, minSupport = 0.2, beam_width=10, g=1, refinement_heuristics = "Inverted Laplace", selection_heuristics = "Laplace", **kwds):
        self.minSupport = minSupport
        self.g = g
        print self.g
        self.CandidatesList = set()
        self.selectionBeamWidth = beam_width
        print self.selectionBeamWidth
...
#                        if len(d_attribute.getValueFrom.transformer.points) > 0:
            ...
            while ms < max_steps:
                ...
                self.printBeam(self.SelectionBeam, "Selection beam")
                ms=ms+1
    ...
    def updateSelectionBeam(self, selectionCandidates):
        ...
        if len(self.selectionCandidates) > self.selectionBeamWidth:
            ...
            self.SelectionBeam = self.selectionCandidates
            # + empty_rule*(self.selectionBeamWidth-len(self.selectionCandidates))
...
if __name__=="__main__":
    ...
    #filename = "/Users/anitavalmarska/Dropbox/_RDM/banded metode/RDM_boolean/ReReMi_boolean_labeled.csv"

    data = orange.ExampleTable(filename)
    print
    learner = DoubleBeam(minSupport=0.01, beam_width=3, g=20, refinement_heuristics = "Laplace", selection_heuristics="Laplace")
    """
